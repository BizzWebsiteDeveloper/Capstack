...
public class GlobalElements extends Application {
    ...
    public static String message_pack_name="DigitalCeramic";
    public static String directory="/DigitalCeramic/walls/";
    public static String document_directory="/DigitalCeramic/document/";
    public static float curScale;
    public static float curRotate;
    public static float curSkewX;
    public static float curSkewY;
    public static String totalcredit,totaldebit,totalmargin,totalbalance;
    public static int count=0;
    public static int pos=0;
    public static View CopyView;
    public static int bmpWidth, bmpHeight;
